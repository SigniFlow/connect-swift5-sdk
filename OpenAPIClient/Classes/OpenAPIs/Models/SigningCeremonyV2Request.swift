//
// SigningCeremonyV2Request.swift
//
...
public struct SigningCeremonyV2Request: Codable {

    public var checkboxFieldsListField: Set<Any>
    public var docField: String
    public var docNameField: String
    public var initialFieldsListField: Set<Any>
    ...
    public var signerIdentificationNumberField: String
    ...
    public var textFieldsListField: Set<Any>

    public init(checkboxFieldsListField: Set<Any>, docField: String, docNameField: String, initialFieldsListField: Set<Any>, loginPasswordField: String, loginUserNameField: String, signatureHField: Double, signatureImageField: String, signatureImageIncludeBorderField: Bool, signatureImageIncludeReasonField: Bool, signatureImageIncludeSignedByField: Bool, signatureImageIncludeSignedDateField: Bool, signatureImageTypeField: Double, signaturePageField: Double, signatureWField: Double, signatureXField: Double, signatureYField: Double, signerEmailField: String, signerFullNameField: String, signerIdentificationNumberField: String, signerLocationField: String, signerMobileNumberField: String, signerReasonField: String, signerTrustOriginField: String, signerTrustReferenceField: String, textFieldsListField: Set<Any>) {
        self.checkboxFieldsListField = checkboxFieldsListField
        self.docField = docField
        self.docNameField = docNameField
        self.initialFieldsListField = initialFieldsListField
        ...
        self.signerIdentificationNumberField = signerIdentificationNumberField
        ...
        self.textFieldsListField = textFieldsListField
    }

    public enum CodingKeys: String, CodingKey, CaseIterable {
        case checkboxFieldsListField = "CheckboxFieldsListField"
        case docField = "DocField"
        case docNameField = "DocNameField"
        case initialFieldsListField = "InitialFieldsListField"
        ...
        case signerIdentificationNumberField = "SignerIdentificationNumberField"
        ...
        case textFieldsListField = "TextFieldsListField"
    }
